"""
DCNv3 (Deformable Convolution v3) implementation for CTD-YOLO
...
class DCNv3(nn.Module):
    """
    Deformable Convolution v3 module
    """
    def __init__(self, channels, kernel_size=3, stride=1, pad=1, dilation=1, group=4, offset_scale=1.0, 
        ...
        if not _d_per_group % 8 == 0:
            print(f"You'd better set channels in DCNv3 to make the dimension of each attention head a multiple of 8, "
...
def dcnv3_core_pytorch(input, offset, mask, kernel_h, kernel_w, stride_h, stride_w, 
...
class DCNv3_Conv(nn.Module):
    """DCNv3 convolution wrapper for easy integration"""
    def __init__(self, c1, c2, k=3, s=1, p=None, g=1, act=True):
        ...
        # Use regular conv if input/output channels don't match DCNv3 requirements
        if c1 != c2 or c1 % 8 != 0:
            ...
            self.dcn = DCNv3(c1, kernel_size=k, stride=s, pad=p)
